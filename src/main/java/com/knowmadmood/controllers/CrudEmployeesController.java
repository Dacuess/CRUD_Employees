...
public class CrudEmployeesController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Employees found successfully",
                    content = @Content(schema = @Schema(implementation = TeammateDTO.class))),
            @ApiResponse(responseCode = "404", description = "There are not employees in data base",
                    content = @Content(schema = @Schema()))})
	@GetMapping("/teammates")
	public List<TeammateDTO> getAllEmployees() throws CrudEmployeesExceptions {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Employee found successfully",
                    content = @Content(schema = @Schema(implementation = TeammateDTO.class))),
            @ApiResponse(responseCode = "404", description = "There are not any employee with the UUID requested",
                    content = @Content(schema = @Schema()))})
	@GetMapping("/teammates/{uuid}")
	public TeammateDTO getEmployeeById(@PathVariable UUID uuid) throws CrudEmployeesExceptions {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "There are not any employee with the UUID requested",
                    content = @Content(schema = @Schema()))})
	public String updateEmployeeById(@PathVariable UUID uuid, @RequestBody TeammateDTO teammateDto) throws CrudEmployeesExceptions {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "There are not any employee with the UUID requested",
                    content = @Content(schema = @Schema()))})
	public String deleteEmployeeById(@PathVariable UUID uuid) throws CrudEmployeesExceptions {
